...
/** approved = decided, not (yet) executed; executing = claimed by one executor (exactly-once guard). */
export const APPROVAL_STATUSES = ["pending", "approved", "executing", "executed", "rejected", "expired", "failed"] as const;
