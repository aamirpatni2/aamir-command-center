...
export const NAV: NavSection[] = [
  {
    ...
    items: [
      ...
      { path: "/today", label: "Needs you", icon: BellRing, milestone: 12, ready: true, permission: "analytics:read", description: "Unanswered chats, quiet hot leads, follow-ups, payments to verify and approvals" },
      ...
      { path: "/insights", label: "AI Insights", icon: Sparkles, milestone: 12, ready: true, permission: "analytics:read", description: "Patterns and recommendations from the Analytics Agent" },
      { path: "/ads", label: "Ads", icon: Megaphone, milestone: 12, ready: true, permission: "campaigns:read", description: "Read-only Meta Ads performance and Marketing Agent analysis" },
      { path: "/analytics", label: "Analytics", icon: BarChart3, milestone: 12, ready: true, permission: "analytics:read", description: "Revenue, lead, conversion, content and campaign analytics" },
    ],
  },
  {
    title: "Education",
    items: [
      ...
      { path: "/reports", label: "Reports", icon: FileText, milestone: 12, ready: true, permission: "analytics:read", description: "Daily and weekly business reports" },
    ],
  },
  {
    title: "Content",
