...
## Deploying
One server with Docker: `cd deploy && ./generate-env.sh && docker compose up -d --build`. HTTPS, backups and least-privilege database access included. Step by step: [docs/DEPLOYMENT.md](docs/DEPLOYMENT.md).
